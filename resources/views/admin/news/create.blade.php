            ...
            <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="type" class="form-control @error('title') is-invalid  @enderror" id="title" name="title" value="{{ old('title') }}">
                        @error('title') 
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('date_uploaded') is-invalid  @enderror" id="date_uploaded" name="date_uploaded" value="{{ old('date_uploaded') }}">
                        @error('date_uploaded') 
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
