...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6 col-12">
            ...
            <h1 class="text-white mb-4 pb-2">News Detail</h1>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-12 mx-auto">
                <h2 class="mb-lg-5 mb-4">{{ $newsDetail->title }}</h2>

                <div class="custom-block-image-wrap d-flex align-items-center justify-content-center">
                    <img src="{{ asset('storage') }}/{{ $newsDetail->picture }}" class="custom-block-image img-fluid" alt="">
                </div>
                ...
                <div class="custom-block-info">
                    ...
                    <div class="events-detail-info row my-5 d-flex align-item-center justify-content-center">
                        <div class="col-lg-12 col-12">
                            <h4 class="mb-3">Info Detail</h4>
                        </div>

                        <div class="col-lg-4 col-12">
                            <span class="custom-block-span">Tanggal Diupload:</span>

                            <p class="mb-0">{{  Carbon::parse($newsDetail->date_uploaded)->format('d M Y'); }}</p>
                        </div>

                        <div class="col-lg-4 col-12">
                            <span class="custom-block-span">Diupload oleh:</span>

                            <p class="mb-0">{{  $newsDetail->user->name }}</p>
                        </div>
                    </div>
